...
<div class="row pad-bottom pad-top">
	<div class="six columns offset-by-three pad-bottom">
		<h1><a href="{path="show/future"}" class="no_ul">100 Future</a>{exp:channel:category_heading relaxed_categories="yes" channel="submissions|archive_submissions"}: {category_name}{/exp:channel:category_heading}</h1>
	</div>
