...
<div class="row pad-bottom">
			...
			<li><a href="/now/2014now" class="present-link">Present</a></li>
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="/show/2014future" class="future-link">Future</a></li>
			</ul>
	<div class="twelve column link-black text-black text-small" style="margin: 0 auto; opacity: 0.85; float: none; margin-left: 7px; top: 10px">
		<p style="text-align: center;max-width: 238px; margin: 0 auto;">The living archive of submitted work, approved by the professional panel.<br><br><a style="border-bottom: 0px" href="{path="learn/kb/future"}">Learn More &rarr;</a></p>
	</div>
</div><!-- Row -->
