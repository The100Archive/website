<div class="royalSlider rsDefault visibleNearby" {if segment_1=="past"}style="margin-top: -150px; margin-bottom: -200px"{/if}>
{submission_images}
	...
	<div class="row">
		...
		<div class="three columns pull-seven" style="overflow:hidden">
			...
			<ul class="text-black">
				...
				<li><a href="{title_permalink="people/profile"}">{title}</a></li>
				{/exp:playa:children}
			...
			<p class="text-black text-small">
				{submission_credits backspace="2"}{credit_name} - {credit_role}; {/submission_credits}
			</p>
