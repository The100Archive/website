...
{exp:channel:entries channel="news" limit="1" status="open|closed"}
			<div class="pad-top row">
			
				<div class="twelve columns link-no-ul">
	...
	<div class="row">
		<div class="ten columns offset-by-one">
			<div class="{news_slideshow}{if total_files > "1"}newsslider {if:else}newsslider_single{/if}{/news_slideshow} royalSlider rsMinW pad-top">
				{news_slideshow}
					<img class="rsImg" src="{exp:ce_img:pair src="{url}" width="1400" allow_scale_larger="yes" crop="no" add_dims="no"}{made}{/exp:ce_img:pair}" alt="{title}">
				{/news_slideshow}
			</div>
		</div>
	</div>
				...
				<div class="two columns offset-by-two">
					<div class="row">
						{exp:playa:children field="news_author" status="not closed"}
								<br />
								<div class="eight columns link-no-ul">
